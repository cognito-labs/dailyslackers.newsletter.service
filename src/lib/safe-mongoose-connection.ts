...
export default class SafeMongooseConnection {
  ...
  private mongoConnectionOptions: ConnectOptions = defaultMongooseConnectionOptions;
  ...
  constructor(options: SafeMongooseConnectionOptions) {
    ...
    if(options.mongooseConnectionOptions) {
      this.mongoConnectionOptions = {...this.mongoConnectionOptions, ...options.mongooseConnectionOptions}
    }
  }
